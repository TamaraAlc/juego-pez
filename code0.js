...
gdjs.gameCode.GDEnemigo3Objects1= [];
gdjs.gameCode.GDEnemigo3Objects2= [];
...
gdjs.gameCode.GDTargetRoundButtonObjects1= [];
gdjs.gameCode.GDTargetRoundButtonObjects2= [];
gdjs.gameCode.GDRoundJoystickObjects1= [];
gdjs.gameCode.GDRoundJoystickObjects2= [];
...
gdjs.gameCode.mapOfGDgdjs_46gameCode_46GDBurbujaObjects1Objects = Hashtable.newFrom({"Burbuja": gdjs.gameCode.GDBurbujaObjects1});
gdjs.gameCode.mapOfGDgdjs_46gameCode_46GDEnemigo3Objects1Objects = Hashtable.newFrom({"Enemigo3": gdjs.gameCode.GDEnemigo3Objects1});
...
gdjs.gameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11919356);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Burbuja"), gdjs.gameCode.GDBurbujaObjects1);
gdjs.copyArray(runtimeScene.getObjects("Enemigo3"), gdjs.gameCode.GDEnemigo3Objects1);

gdjs.gameCode.condition0IsTrue_0.val = false;
{
gdjs.gameCode.condition0IsTrue_0.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.gameCode.mapOfGDgdjs_46gameCode_46GDBurbujaObjects1Objects, gdjs.gameCode.mapOfGDgdjs_46gameCode_46GDEnemigo3Objects1Objects, false, runtimeScene, false);
}if (gdjs.gameCode.condition0IsTrue_0.val) {
/* Reuse gdjs.gameCode.GDBurbujaObjects1 */
/* Reuse gdjs.gameCode.GDEnemigo3Objects1 */
{gdjs.evtTools.sound.playSound(runtimeScene, "sonido-muerte.mp3", false, 100, 1);
}{for(var i = 0, len = gdjs.gameCode.GDEnemigo3Objects1.length ;i < len;++i) {
    gdjs.gameCode.GDEnemigo3Objects1[i].deleteFromScene(runtimeScene);
}
}{for(var i = 0, len = gdjs.gameCode.GDBurbujaObjects1.length ;i < len;++i) {
    gdjs.gameCode.GDBurbujaObjects1[i].deleteFromScene(runtimeScene);
}
...
{
for(var i = 0, k = 0, l = gdjs.gameCode.GDpezObjects1.length;i<l;++i) {
    if ( gdjs.gameCode.GDpezObjects1[i].getCenterYInScene() >= 475 ) {
        gdjs.gameCode.condition1IsTrue_0.val = true;
        gdjs.gameCode.GDpezObjects1[k] = gdjs.gameCode.GDpezObjects1[i];
        ++k;
    }
}
gdjs.gameCode.GDpezObjects1.length = k;}}
if (gdjs.gameCode.condition1IsTrue_0.val) {
...
gdjs.gameCode.GDEnemigo3Objects1.length = 0;
gdjs.gameCode.GDEnemigo3Objects2.length = 0;
...
gdjs.gameCode.GDTargetRoundButtonObjects1.length = 0;
gdjs.gameCode.GDTargetRoundButtonObjects2.length = 0;
gdjs.gameCode.GDRoundJoystickObjects1.length = 0;
gdjs.gameCode.GDRoundJoystickObjects2.length = 0;
